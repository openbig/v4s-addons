...
##############################################################################
{
    'name': 'Account Bank Integration - Hibiscus CSV Parser',
    'version': '0.04 (6.1)',
    'license': 'GPL-3',
    'author': 'Grzegorz Grzelak for big-bonsulting GmbH',
    'website': 'http://www.big-consulting.net',
...
#        'account_banking_workflow.xml',
    ...
    'demo_xml': [],
    'description': '''
    Hibiscus CSV Parser Module for bank integration.

    The module conatains two pairs of parser
    1. Online Hibiscus parser import and export (import was never tested)
