...
#    _order = 'id'
    _order = "id desc"
    _columns = {
        'banking_id': fields.many2one('account.banking.exported.file', 'Exported File', readonly=True, ),
    }
account_payment()
...
#    _description= 'Payment Mode'
    _columns = {
        'banking_settings_id': fields.many2one('bank.integration.settings','Export Settings', help='Settings for Payment Export'),
    }
payment_mode()
