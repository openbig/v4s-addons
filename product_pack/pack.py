...
class product_product( osv.osv ):
    ...
    def get_product_available( self, cr, uid, ids, context=None ):
        ...
        result={}
        # GG line below moved as in original module it was two lines lower and very ineffective
        stock = super( product_product, self ).get_product_available( cr, uid, ids, context=context )
